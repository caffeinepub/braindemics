// Academic Packing Status page - view packing status for Academic role
...
export default function AcademicPackingStatusPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Packing Status</h1>
        <p className="text-muted-foreground mt-1">View packing status for all schools</p>
      </div>
