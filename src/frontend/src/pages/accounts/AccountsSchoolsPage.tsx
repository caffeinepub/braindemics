// Accounts Schools page - school browsing for Accounts role
...
export default function AccountsSchoolsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Browse all schools</p>
      </div>
